...
- collaboration preference now influences both planning and expression, so the response can lean more guiding or more action-oriented even when the request itself is short or ambiguous
