...
- next improvement:
  ...
  - decide whether `goal_milestone_arc`, `goal_milestone_pressure`, `goal_milestone_dependency_state`, `goal_milestone_due_state`, and `goal_milestone_due_window` should remain lightweight semantic compressions over milestone history and active tasks, or become part of a richer milestone-lifecycle model with stronger state transitions and due/deadline semantics
